...
void OBSBasic::PasteShowHideTransition(obs_sceneitem_t *item, bool show, obs_source_t *tr)
{
...
{
	bool labels = previewProgramMode ? config_get_bool(GetGlobalConfig(), "BasicWindow", "StudioModeLabels")
					 : false;
