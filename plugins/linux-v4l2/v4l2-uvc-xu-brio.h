...
struct uvc_xu_control_query BRIO_QUERIES_FOV_65[] = {
	{.selector = LOGITECH_BRIO_FOV_SEL,
	 .query = UVC_SET_CUR,
	 .size = 1,
	 .data = "\x02"}};
...
struct menu_item_pos BRIO_MENU_POSITIONS[] = {
	{.label = "65",
	 .queries_cnt = sizeof(BRIO_QUERIES_FOV_65) /
			sizeof(struct uvc_xu_control_query),
	 .queries = BRIO_QUERIES_FOV_65},
	{.label = "78",
	 .queries_cnt = sizeof(BRIO_QUERIES_FOV_78) /
			sizeof(struct uvc_xu_control_query),
	 .queries = BRIO_QUERIES_FOV_78},
	{.label = "90",
	 .queries_cnt = sizeof(BRIO_QUERIES_FOV_90) /
			sizeof(struct uvc_xu_control_query),
	 .queries = BRIO_QUERIES_FOV_90}};

struct menu_item BRIO_MENU[] = {{.id = "brio_fov",
				 .label = "FOV",
				 .positions_cnt = sizeof(BRIO_MENU_POSITIONS) /
						  sizeof(struct menu_item_pos),
