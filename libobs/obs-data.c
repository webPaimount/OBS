...
static inline void set_json_obj(json_t *json, const char *name, obs_data_item_t *item)
{
...
static inline void set_json_array(json_t *json, const char *name, obs_data_item_t *item)
{
